  ...
  return (
    <div className="gpt3__navbar">
      ...
      <div className="gpt3__navbar-sign">
        ...
        {!user && <button type="button" onClick={() => setModalType('SIGN_IN')}>Sign In</button>}
        {!user && <button type="button" onClick={() => setModalType('SIGN_UP')}>Sign Up</button>}
        <Modal
        ...
        >
          ...
          {modalType === 'SIGN_UP' && <SignUp onSignUp={handleSignUp} />}
          <button
            type="button"
